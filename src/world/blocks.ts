...
export const P = {
  ...
  magentaGlass: bs("minecraft:magenta_stained_glass"),
  blueGlass: bs("minecraft:blue_stained_glass"),
  pinkGlass: bs("minecraft:pink_stained_glass"),
  ...
  purpleGlassPane: bs("minecraft:purple_stained_glass_pane"),
  cyanGlassPane: bs("minecraft:cyan_stained_glass_pane"),
  limeGlassPane: bs("minecraft:lime_stained_glass_pane"),
  magentaGlassPane: bs("minecraft:magenta_stained_glass_pane"),
