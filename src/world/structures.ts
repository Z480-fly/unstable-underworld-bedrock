 ...
 * Horizontal, unlike a vertical sphere spire - use it as a floor medallion or
 * set into a roof/dome so it reads as an eye looking straight up or down.
 */
...
/**
 * A portal frame split down the middle: obsidian + a lit nether portal on one
 * half, an eyed end-portal frame + end_portal on the other, with a corrupted
 * seam column (alternating crying obsidian / end rod) where the two halves
 * collide.
 *
